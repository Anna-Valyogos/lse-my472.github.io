...
dbGetQuery(db, 
  ...
  LIMIT 10") # can we keep the column of the variable used for joining?
...
dbGetQuery(db, 
  ...
  LIMIT 1")
dbGetQuery(db, 
  "SELECT congress.screen_name, posts.screen_name, posts.message, posts.shares_count, congress.party 
  FROM posts JOIN congress
    ON congress.screen_name = posts.screen_name")
```
...
dbGetQuery(db, 
  ...
  GROUP BY from_name
  LIMIT 10")
# order matters for the query to work
```
