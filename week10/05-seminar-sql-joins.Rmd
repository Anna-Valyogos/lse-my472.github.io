...
db <- dbConnect(RSQLite::SQLite(), "C:/Users/valyo/Downloads/MASTERS/MY472/lse-my472.github_all_material/week10/facebook-data/facebook-db-mini.sqlite")
# reading the first file
congress <- read.csv("C:/Users/valyo/Downloads/MASTERS/MY472/lse-my472.github_all_material/week10/facebook-data/congress-facebook-2017.csv",
	stringsAsFactors=F)
...
fls <- list.files("C:/Users/valyo/Downloads/MASTERS/MY472/lse-my472.github_all_material/week10/facebook-data/posts", full.names=TRUE)
set.seed(20191212)
