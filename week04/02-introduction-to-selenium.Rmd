...
```{r}
rD<- rsDriver(port = 5556L, browser=c("firefox"))
driver <- rD$client
```
...
agree_button <- driver$findElement(using = "xpath", value = "/html/body/div/c-wiz/div[2]/div/div/div/div/div[2]/form/div/span/span")
...
```{r}
search_field <- driver$findElement(using = "xpath", value = "/html/body/div/div[2]/form/div[2]/div[1]/div[1]/div/div[2]/input")
...
```{r}
first_link <- driver$findElement(using = "xpath", value = "/html/body/div[7]/div[2]/div[10]/div[1]/div[2]/div/div[2]/div[2]/div/div/div[1]/div/div/div/div[1]/a/h3/span")
