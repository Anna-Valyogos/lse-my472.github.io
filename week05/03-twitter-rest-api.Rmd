...
authentication <- list(consumer_key = "Z5IKectiIqZcq9cJVXvJMQ5ND",
                 ...
                 access_token = "1320776729556885504-JsNFPwhmZexBnVS8ndQmZWSzrinHzt",
                 access_token_secret = "rXV2lGcVfXVFaV3vOxyy7r9Zrg3cM4utsox7UIVUyKEkz")
```
...
twitter_token <- create_token(app = "MY472 - API practice", 
