...
```{r}
current_dir <- "C:/Users/valyo/Downloads/MASTERS/MY472/lse-my472.github_all_material/week05"
```

Reading/parsing the first file into R:

```{r}
example_1_parsed <- fromJSON(paste(current_dir, "example1.json", sep = "/"))
...
```{r}
example_2_parsed <- fromJSON(paste(current_dir, "example2.json", sep = "/"))
