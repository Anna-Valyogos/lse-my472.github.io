...
p + scale_x_log10(labels = comma) + scale_y_log10(labels = comma) +
...
```{r}
p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) +theme_bw()

p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) + theme_grey()

p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) + theme_minimal()

p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) + theme_classic()
```
...
```{r}
p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) + theme( axis.ticks = element_blank() )
```
...
```{r}
pq <- p + geom_point() + scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) +
